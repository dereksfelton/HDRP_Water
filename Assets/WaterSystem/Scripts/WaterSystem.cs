...
namespace WaterSystem
{
    ...
    public class WaterSystem : MonoBehaviour
    {
        ...
        [Tooltip("Reference to the water currentProfile containing all visual settings")]
        public WaterProfile currentProfile;
        ...
        private void OnValidate()
        {
            ...
            // Apply currentProfile settings when currentProfile is changed
        ...
        private void Initialize()
        {
            ...
            // Apply currentProfile settings if available
            if (currentProfile != null)
            {
                currentProfile.ApplyToWaterSystem(this);
            }
