...
at Assets/WaterSystem/Shaders/WaterCore.hlsl(19)
```
...
```
WaterCore.hlsl (UPDATED)    → Assets/WaterSystem/Shaders/
WaterProfile.cs (UPDATED)   → Assets/WaterSystem/Scripts/
WaterSurface.shader (FIXED) → Assets/WaterSystem/Shaders/
