...
cp *.cs /path/to/UnityProject/Assets/WaterSystem/Scripts/
cp *.hlsl /path/to/UnityProject/Assets/WaterSystem/Shaders/
cp *.md /path/to/UnityProject/Assets/WaterSystem/Documentation/
```
