...
### Shader Files
- [ ] Copy `WaterSurface.shader` to `Assets/AdvancedWater/Shaders/`
- [ ] Replace `WaterCore.hlsl` in `Assets/AdvancedWater/Shaders/`
- [ ] No shader compilation errors in Console
- [ ] Shader appears in Shader dropdown menu

### Script Files
- [ ] Create folder `Assets/AdvancedWater/Editor/` (if doesn't exist)
- [ ] Replace `WaterProfile.cs` in `Assets/AdvancedWater/Scripts/`
- [ ] Copy `WaterSurfaceShaderGUI.cs` to `Assets/AdvancedWater/Editor/`
- [ ] No C# compilation errors in Console

### Material Creation
- [ ] Create folder `Assets/AdvancedWater/Materials/` (if doesn't exist)
...
- [ ] Right-click `Assets/AdvancedWater/Profiles/`
