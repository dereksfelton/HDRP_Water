...
### Updated (Correct)
- **Path**: `Assets/AdvancedWater/`
- **Namespace**: `AdvancedWater`
- **Editor Namespace**: `AdvancedWater.Editor`
...
- ✅ WaterProfile.cs - `namespace AdvancedWater`
- ✅ WaterSurfaceShaderGUI.cs - `namespace AdvancedWater.Editor`
- ✅ WaterSurface.shader - `CustomEditor "AdvancedWater.Editor.WaterSurfaceShaderGUI"`
...
WaterCore.hlsl           → Assets/AdvancedWater/Shaders/ (REPLACE)
WaterProfile.cs          → Assets/AdvancedWater/Scripts/ (REPLACE)
...
- "type or namespace AdvancedWater does not exist"
```
...
Assets/AdvancedWater/Editor/WaterSurfaceShaderGUI.cs  ✓
```
...
- Custom Editor: AdvancedWater.Editor.WaterSurfaceShaderGUI ✓
```
...
All files now use the correct **Assets/AdvancedWater/** path structure.
