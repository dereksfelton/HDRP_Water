...
3. **WaterProfile.cs** (253 lines)
   ...
   - Location: `Assets/AdvancedWater/Scripts/`
...
4. **WaterSurfaceShaderGUI.cs** (248 lines)
   ...
   - Location: `Assets/AdvancedWater/Editor/`
...
WaterCore.hlsl        → Assets/AdvancedWater/Shaders/ (REPLACE existing)
```
...
Source Files → Destination
─────────────────────────────────────────────────────
WaterProfile.cs       → Assets/AdvancedWater/Scripts/ (REPLACE existing)

WaterSurfaceShaderGUI.cs → Assets/AdvancedWater/Editor/
```

**Important**: Create the `Editor` folder if it doesn't exist:
- Right-click `Assets/AdvancedWater/`
- Create → Folder
- Name it "Editor"

### Step 3: Create Material

1. Navigate to `Assets/AdvancedWater/Materials/`
...
1. Right-click `Assets/AdvancedWater/Profiles/`
...
1. Move WaterSurfaceShaderGUI.cs to `Assets/AdvancedWater/Editor/`
