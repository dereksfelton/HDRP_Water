...
**Core Scripts**: `Assets/AdvancedWater/Scripts/`  
**Shaders**: `Assets/AdvancedWater/Shaders/`  
**Profiles**: `Assets/AdvancedWater/Profiles/` (you create this)  
**Materials**: `Assets/AdvancedWater/Materials/` (you create this)
