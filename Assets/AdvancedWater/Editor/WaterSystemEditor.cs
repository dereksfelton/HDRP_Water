...
namespace AdvancedWater.Editor
{
    ...
    public class WaterSystemEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (waterSystem.profile != lastProfile)
            {
                lastProfile = waterSystem.profile;
            ...
            if (waterSystem.profile != null)
            {
                EditorGUILayout.HelpBox(
                    $"Current Profile: {waterSystem.profile.profileName}\n" +
        ...
        private void ApplyProfile(WaterSystem waterSystem)
        {
            ...
            Debug.Log($"[WaterSystem] Starting to apply profile: {waterSystem.profile.profileName}");
            
            // Apply to WaterSystem
            waterSystem.profile.ApplyToWaterSystem(waterSystem);
            ...
            if (renderer != null)
            {
                ...
                if (renderer.sharedMaterial != null)
                {
                    ...
                    // Apply profile
                    waterSystem.profile.ApplyToMaterial(mat);
                    ...
                    Debug.Log($"[WaterSystem] ✓ Applied profile: {waterSystem.profile.profileName}");
                }
                else
                {
